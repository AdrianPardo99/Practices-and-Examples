...
/*Función que compara dos enteros para saber su altura*/
...
/*Función que saca la alturade un arbol*/
int Altura(ArBin a){return (!esvacio(a))?(1+max(Altura(izquierdo(a)),Altura(derecho(a)))):(0);}
/*Función que imprime la altura del arbol binario*/
void AlturaAB(ArBin a){printf("Altura del arbol es: %d\n",Altura(a));}
/*Función que imprime el peso del arbol binario*/
void NElemAB(ArBin a){printf("Peso del arbol es: %d\n",numElemA(a));}
